...
export const ITEM_RULES: ItemRule[] = [
  ...
  { re: /オレンジジュース|オレンジ\s*100/, item: "オレンジジュース" },
  { re: /パインジュース|パイナップル|パイン/, item: "パインジュース" },
  { re: /グァバ|グアバ/, item: "グァバジュース" },
  { re: /グロリア|ジュース/, item: "ジュース（その他）" },
  { re: /牛乳|ミルク/, item: "牛乳" },

  // ── コーヒー・茶
  { re: /コーヒー豆|焙煎|ドリップ|エスプレッソ/, item: "コーヒー豆" },
  { re: /抹茶/, item: "抹茶" },
  { re: /お[～ーはい]*いお茶|緑茶|煎茶|ほうじ茶/, item: "緑茶" },
  ...
  { re: /バター/, item: "バター" },
  { re: /クリームチーズ/, item: "クリームチーズ" },
  { re: /シュレッ?ダー|とろけるチーズ|ピザ用チーズ/, item: "シュレッダーチーズ" },
  { re: /ブルーチーズ|ゴルゴンゾーラ/, item: "ブルーチーズ" },
  { re: /パルミジャー|パルメザン/i, item: "パルミジャーノ" },
  { re: /モッツァレラ/i, item: "モッツァレラ" },
  { re: /カマンベール/i, item: "カマンベール" },
  { re: /チーズ/, item: "チーズ（その他）" },
  { re: /鶏卵|たまご|卵/, item: "卵" },
  // ── リキュール・スピリッツ（追加）
  ...
  // ── ソフトドリンク（追加）
  { re: /スプライト/i, item: "スプライト" },
  { re: /ペリエ/i, item: "ペリエ" },
  { re: /炭酸水|ソーダ/i, item: "炭酸水" },
  { re: /クランベリー/, item: "ジュース" },
  { re: /氷|純氷/, item: "氷" },
  ...
  { re: /ベーコン/, item: "ベーコン" },
  { re: /サラミ/, item: "サラミ" },
  { re: /ソーセージ|ウインナー|ウィンナー/, item: "ソーセージ" },
  { re: /ハム/, item: "ハム" },
  { re: /ツナ|シーチキン/, item: "ツナ" },
  { re: /オリーブオイル/, item: "オリーブオイル" },
  { re: /ごま油|胡麻油/, item: "ごま油" },
  { re: /サラダ油|キャノーラ|オイル/, item: "サラダ油" },
  { re: /アイスクリーム|ジェラート|バニラ.*2L/, item: "アイスクリーム" },
  { re: /ピクルス|ディルピクルス/, item: "ピクルス" },
  { re: /オリーブ(?!オイル)/, item: "オリーブ" },
  { re: /鮒ずし|鮒寿司/, item: "鮒ずし" },
  { re: /食パン|超熟|本仕込/, item: "食パン" },
  { re: /バゲット|フランスパン/, item: "バゲット" },
  { re: /クロワッサン/, item: "クロワッサン" },
  { re: /バンズ/, item: "バンズ" },
  { re: /パン/, item: "パン（その他）" },
  { re: /中双糖|ザラメ|ざらめ/, item: "ザラメ（ワッフル用）" },
  { re: /砂糖|上白糖|グラニュー/, item: "砂糖" },
  { re: /薄力粉/, item: "薄力粉" },
  { re: /強力粉/, item: "強力粉" },
  { re: /ワッフルミックス|ミックス粉/, item: "ワッフルミックス" },
  { re: /小麦粉/, item: "小麦粉" },
  { re: /ケチャップ/, item: "ケチャップ" },
  { re: /マヨネーズ/, item: "マヨネーズ" },
  { re: /マスタード/, item: "マスタード" },
  { re: /ウスターソース|中濃ソース|とんかつソース|お好み|焼きそばソース/, item: "ソース" },
  { re: /醤油|しょうゆ|しょう油/, item: "醤油" },
  { re: /みそ|味噌/, item: "味噌" },
  { re: /みりん|味醂/, item: "みりん" },
  { re: /(?<!食)酢(?!豚)|ビネガー/, item: "酢" },
  { re: /わさび|ワサビ/, item: "わさび" },
  { re: /ソース/, item: "ソース" },
  { re: /ムキエビ|むき海老|むきえび|バナメイ/, item: "むき海老" },
  { re: /えびまめ煮|えび豆/, item: "えび豆" },
  { re: /あみえび/, item: "あみえび" },
  { re: /こんにゃく/, item: "こんにゃく" },
  { re: /はんぺん/, item: "はんぺん" },
  { re: /袋代/, item: "レジ袋・紙袋" },
  { re: /大葉|しそ|シソ/, item: "大葉" },
  { re: /にんにく|ニンニク/, item: "にんにく" },
  { re: /アボカド/, item: "アボカド" },
  { re: /ミニトマト|プチトマト/, item: "ミニトマト" },
  { re: /マッシュルーム/, item: "マッシュルーム" },
  { re: /ほうれん草/, item: "ほうれん草" },
  { re: /ブロッコリー/, item: "ブロッコリー" },
  { re: /レタス/, item: "レタス" },
  { re: /玉ねぎ|玉ネギ|タマネギ/, item: "玉ねぎ" },
  { re: /じゃがいも|ジャガイモ|馬鈴薯|ポテトフレーク/, item: "じゃがいも" },
  { re: /野菜/, item: "野菜（その他）" },
  { re: /ライム/, item: "ライム" },
  { re: /レモン/, item: "レモン" },
  { re: /バナナ/, item: "バナナ" },
  { re: /いちご|イチゴ|苺/, item: "いちご" },
  { re: /ブルーベリー/, item: "ブルーベリー" },
  { re: /果実|フルーツ/, item: "果物（その他）" },
  ...
  { re: /ローリエ|ローレル/, item: "ローリエ" },
  { re: /パセリ/, item: "パセリ" },
  { re: /ミント/, item: "ミント" },
  { re: /唐辛子|鷹の爪/, item: "唐辛子" },
  { re: /ペストロ|ジェノベーゼ|ペスト(?!ロ)/, item: "ペストロ（バジルソース）" },
  { re: /バジル/, item: "バジル" },
  { re: /オレガノ/, item: "オレガノ" },
  { re: /GABAN|S&B|スパイス/i, item: "スパイス（その他）" },
  ...
  { re: /カルピス/, item: "カルピス" },
  { re: /ゆず茶/, item: "ゆず茶" },
  { re: /ジャスミン/, item: "ジャスミン茶" },
  { re: /麦茶/, item: "麦茶" },
  { re: /ほうじ茶/, item: "ほうじ茶" },
  { re: /お[～〜ー]いお茶|緑茶|煎茶/, item: "緑茶" },
  { re: /ポッカ/, item: "レモン果汁" },

  // ── 食材（追加）
  { re: /サーモン|鮭/, item: "サーモン" },
  { re: /大アサリ|あさり|アサリ/, item: "大アサリ" },
  { re: /コンミート|コンビーフ/, item: "コンビーフ" },
  { re: /佃煮/, item: "佃煮" },
  { re: /えび|エビ/, item: "えび" },
  { re: /キャベツ/, item: "キャベツ" },
  { re: /ベビーリーフ/, item: "ベビーリーフ" },
  { re: /マンゴー/, item: "マンゴー" },
  { re: /オレンジ100/, item: "オレンジジュース" },
  { re: /朝の輝き|朝の耀き|フジ本仕込|石窯|カマ$|ミニカマ|くらしモア/, item: "パン" },
  { re: /チップチョコ|パルメ/, item: "チョコ・ココア" },
  { re: /パウダーシュガー|シュガーパウダー/, item: "パウダーシュガー（ワッフル用）" },
  { re: /麹/, item: "麹" },
  { re: /うま味調味料|味の素/, item: "うま味調味料" },
  ...
  { re: /マドラー/, item: "マドラー" },
  { re: /シュガーシロップ/, item: "シュガーシロップ（お客用）" },
  { re: /ストロー|カップ|コースター|おしぼり|ツマヨウジ|楊枝/, item: "使い捨て用品" },
  ...
  { re: /クレンザ|ウタマロ|弾き耐久|キッチンハイター|キッチン泡/, item: "清掃用品（キッチン）" },
  { re: /デッキブラシ|ループツキタオル|タオル/, item: "掃除用品" },
  { re: /冷水筒|ウォーターポット/, item: "カフェ用品" },
  { re: /ココット/, item: "グラス・食器" },
  { re: /ビッグマック|マックポーク|ナゲット|マックフライ|ハッピーセット/, item: "飲食（会議・打合せ）" },
  { re: /マナイタ|まな板|トング|アワタテ|泡立て|ヘラ|すりこぎ|スリロギ|ギボウ|計量スプーン/, item: "調理機器" },
  { re: /CCケーブル|USBケーブル|充電ケーブル/i, item: "IT機器" },
  { re: /ロック式容器|タイトロック|ホゾンビン|ホゾンヨウキ|保存容器|保存瓶|オリンヨウキ/, item: "保存容器" },
  { re: /ゴミブタ|ゴミ箱|ペール/, item: "ゴミ袋・ペール" },
  { re: /メッシュパネル|スケルトンボックス/, item: "棚・収納" },
  { re: /ショッキセンザイ|食器洗剤|ジョイ|キュキュット/, item: "洗剤" },
  { re: /コルクヌキ|コルク抜き|ソムリエナイフ|栓抜き/, item: "バー器具" },
  { re: /クレ5-?56|CRC|潤滑/, item: "工具・作業用品" },
  { re: /クリップ\s|クリップ$/, item: "文房具" },
  { re: /薄焼|食パン|ロールパン/, item: "パン" },
  { re: /レジャーコップ/, item: "使い捨て用品" },
  { re: /建築補修材|補修材|パテ/, item: "内装材料" },
  { re: /バスケット|カゴ/, item: "雑貨・インテリア" },
  { re: /延長保証|スタンダードプラン.*保証/, item: "IT機器" },
  ...
  { re: /カフェ用具/, item: "カフェ用品" },
  // ---- 2026-08-30 未登録レシートの空欄52行を拾う分。 ----
  // どれも既存ルールに当たらない語なので、末尾追加で安全（先勝ちのため）。
  { re: /成分無調整|酪農/, item: "牛乳" },
  { re: /戸車/, item: "ネジ・金具" },
  { re: /ブラノジ/, item: "ネジ・金具" },
  { re: /駐車料金|コインパーキング|パーキング/, item: "駐車料金" },
  { re: /レジブック/, item: "レジ袋・紙袋" },
  { re: /ローソン ?アイス/, item: "アイスクリーム" },
  { re: /虫コロリ|殺虫|防虫/, item: "防虫・殺虫剤" },
  { re: /トイレブラシ|ペーパーホルダー/, item: "清掃用品（トイレ）" },
  { re: /ハンドソープ|ハンドラボ/, item: "衛生用品" },
  { re: /詰替ボトル|詰め替えボトル/, item: "容器" },
  { re: /キュウスイマット|吸水マット/, item: "清掃用品（キッチン）" },
  { re: /ガッシュ/, item: "塗装材料" },
  { re: /ハコビタイ|運び台/, item: "工具・作業用品" },
  { re: /デザートスプーン/, item: "テイクアウト用品（カトラリー）" },
  { re: /ラグジュアリッチ/, item: "コーヒー豆" },
  { re: /ジンジャー1\.?5/, item: "ジンジャーエール" },
  { re: /ディッシャー|ボウラー/, item: "調理機器" },
  { re: /出店料/, item: "出店料" },
  { re: /入会|年会費/, item: "会費・入会金" },
  { re: /天然水|ミネラルウォーター/, item: "水" },
  // はま寿司・兎流の打合せ飲食。行名がメニュー名で来るのでそれで拾う。
  { re: /麻婆定食|部門01|円椀|プラチナ皿/, item: "飲食（会議・打合せ）" },
  { re: /マッキー|朱肉|キャンパス|^ラベル$/, item: "文房具" },
  { re: /定形外|速達|郵便料金|ゆうパック|切手/, item: "郵送料" },
  { re: /手縫い針|三角針|ウーリーロック|手芸/, item: "裁縫用品" },
  { re: /CD1\.5L/, item: "コーラ" },
  { re: /冷凍庫/, item: "冷凍庫" },
  { re: /パドルボート|スタンドアップパドル/, item: "SUPボード" },
];
